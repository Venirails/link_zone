...
class LikesController < ApplicationController
  ...
  def create
    @recipient = params[:likeable_type].constantize.find(params[:likeable_id])
    @likeable.liked_by current_user
    @likeable.create_activity(:like, owner: current_user, recipient: @recipient.user, read_status: false )
  end
